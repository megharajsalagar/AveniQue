...
public class InternalExamqp extends AppCompatActivity {
    FirebaseStorage firebaseStorage;
    StorageReference storageReference, ref;
    ArrayList<InternalQuestionPapers> internalQuestionPapersArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internal_examqp);
        StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        StrictMode.setVmPolicy(builder.build());
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        back_button=(ImageView)findViewById(R.id.btn_back5);
       internalQuestionPapersArrayList = getIntent().getParcelableArrayListExtra("internalqpapers_list");
        getSupportActionBar().setTitle("");
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setLogo(R.drawable.actionbar_icon);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
       internalAdapter = new InternalAdapter(internalQuestionPapersArrayList,InternalExamqp.this);
   ...
   /*    branch = getIntent().getStringExtra("Branch");
        ...
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                downloadFiles(InternalExamqp.this, fileName, ".pdf", DIRECTORY_DOWNLOADS, url);
    ...
    public void view_pdf(String fileName) {
        ...
        try {
            ...
            Toast.makeText(InternalExamqp.this, "No Application available to view PDF", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.Home:
                   ...
                   Intent intent=new Intent(InternalExamqp.this,entry.class);
